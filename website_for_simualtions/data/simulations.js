...
const SIMS = [
  ...
  { id: 'pseudo-force', topic: 'mechanics', title: 'Pseudo Force',
  ...
  { id: 'constrained-motion', topic: 'mechanics', title: 'Constrained Motion Lab',
    ...
    thumb: '../constrained_motion/Screenshot 2026-07-17 181418.png',
    youtube: '' },

  { id: 'movable-pulley', topic: 'mechanics', title: 'Movable Pulley',
  ...
  /* ---------------- VECTORS ---------------- */
  { id: 'draw-a-vector', topic: 'vectors', title: 'Draw a Vector',
  ...
  { id: 'vector-addition', topic: 'vectors', title: 'Vector Addition',
  ...
  { id: 'dot-product', topic: 'vectors', title: 'Dot Product',
  ...
  { id: 'cross-product', topic: 'vectors', title: 'Cross Product',
  ...
  /* ---------------- AC CIRCUITS ---------------- */
  { id: 'lc-circuit', topic: 'ac-circuits', title: 'LC Circuit',
  ...
  { id: 'lcr-circuit', topic: 'ac-circuits', title: 'LCR Circuit',
  ...
  { id: 'lr-circuit', topic: 'ac-circuits', title: 'LR Circuit',
  ...
  { id: 'rc-circuit', topic: 'ac-circuits', title: 'RC Circuit',
  ...
  /* ---------------- ELECTRICITY ---------------- */
  { id: 'resistor-cube', topic: 'electricity', title: 'Resistor Cube Network',
  ...
  /* ---------------- ELECTROSTATICS ---------------- */
  { id: 'dipole', topic: 'electrostatics', title: 'Electric Dipole',
  ...
  { id: 'flux', topic: 'electrostatics', title: 'Electric Flux',
  ...
  { id: 'fields-produced', topic: 'electrostatics', title: 'Fields Produced',
  ...
  /* ---------------- MAGNETISM ---------------- */
  { id: 'biot-savart', topic: 'magnetism', title: 'Biot-Savart: Straight Wire',
  ...
  { id: 'lorentz-motion', topic: 'magnetism', title: 'Lorentz Motion',
  ...
  { id: 'magnets-grade-10', topic: 'magnetism', title: 'Magnets (Grade 10)',
  ...
  /* ---------------- OPTICS ---------------- */
  { id: 'concave-mirror', topic: 'optics', title: 'Concave Mirror',
  ...
  { id: 'human-eye', topic: 'optics', title: 'The Human Eye',
